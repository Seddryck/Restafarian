...
- Accept: single value. When omitted Restafarian will select the engine based on the extension of the template file.
...
- Accept: single value.
- Mandatory: no expect if `--stdin` is specified. When omitted Restafarian will select the parser based on the extension of the source file
