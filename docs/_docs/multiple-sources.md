---
title: Using Multiple Sources in Restafarian
tags: [cli-usage]
---
...
```powershell
restafarian -t template.html -s user:user.yaml;settings:config.json -o output.html
```
...
With this approach, Restafarian provides flexibility in managing multi-source data, making it easy to build robust, organized models for dynamic template generation.
